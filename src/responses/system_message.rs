...
impl From<&mut Packet> for SystemMessageResponse {
    fn from(packet: &mut Packet) -> Self {
        ...
        SystemMessageResponse { message, color }
    }
}

impl From<&SystemMessageResponse> for Packet {
    fn from(val: &SystemMessageResponse) -> Self {
