...
#[derive(Debug)]
pub struct PlayerSkillsResponse {
    pub skills: Vec<Skill>,
}

impl From<&mut Packet> for PlayerSkillsResponse {
...
impl From<&PlayerSkillsResponse> for Packet {
    fn from(val: &PlayerSkillsResponse) -> Self {
