...
impl From<&mut Packet> for PlayerExtraAgility {
    fn from(packet: &mut Packet) -> Self {
        ...
        PlayerExtraAgility { extra_agility, on_target_point, evasion, unknown_evasion_copy, minimum_physical_attack, maximum_physical_attack  }
    }
}

impl From<&PlayerExtraAgility> for Packet {
    fn from(val: &PlayerExtraAgility) -> Self {
