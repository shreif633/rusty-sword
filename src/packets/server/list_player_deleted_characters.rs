...
#[derive(Debug)]
pub struct ListPlayerDeletedCharacters {
    pub characters: Vec<PlayerDeletedCharacter>,
}

impl From<&mut Packet> for ListPlayerDeletedCharacters {
    fn from(packet: &mut Packet) -> Self {
        ...
        ListPlayerDeletedCharacters { characters }
    }
}

impl From<&ListPlayerDeletedCharacters> for Packet {
    fn from(val: &ListPlayerDeletedCharacters) -> Self {
