...
impl From<&mut Packet> for PlayerExtraWisdom {
    fn from(packet: &mut Packet) -> Self {
        ...
        PlayerExtraWisdom { extra_wisdom, current_magic_points, maximum_magic_points, minimum_magical_attack, maximum_magical_attack, curse_resistence  }
    }
}

impl From<&PlayerExtraWisdom> for Packet {
    fn from(val: &PlayerExtraWisdom) -> Self {
