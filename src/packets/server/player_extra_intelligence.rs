...
#[derive(Debug)]
pub struct PlayerExtraIntelligence {
...
impl From<&mut Packet> for PlayerExtraIntelligence {
    fn from(packet: &mut Packet) -> Self {
        ...
        PlayerExtraIntelligence { extra_intelligence, minimum_magical_attack, maximum_magical_attack, fire_resistence, ice_resistence, lighning_resistence }
    }
}

impl From<&PlayerExtraIntelligence> for Packet {
    fn from(val: &PlayerExtraIntelligence) -> Self {
